...
void main_cubic_traj()
{
  double CT[12];
  double vi_tmp[3];
  // Initialize function 'cubic_traj' input arguments.
  ...
  // Call the entry-point 'cubic_traj'.
  cubic_traj(argInit_real_T(), vi_tmp, vi_tmp, vi_tmp, vi_tmp);
}
